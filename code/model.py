...
if __name__ == '__main__':
    ...
    dfs = [test_id, base_info, other_info, news_info, change_info]
    ...
    fillna_col = ['news_sum', 'news_pos_sum', 'news_mid_sum', 'news_neg_sum', 'bgsum']
    for col in fillna_col:
        test_data[col].fillna(0, inplace=True)

    test_data.to_csv('./test_data_1106.csv', index=False)

    # trian and predict
    train_pred_lgb(train_fea, features, test_data, cat_feature, './submit_1106.csv')
